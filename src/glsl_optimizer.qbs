...
Project {
    ...
    StaticLibrary {
        ...
        Properties {
            ...
            cpp.defines: outer.concat(["__STDC_VERSION__=199901L",
                                       "__STDC__",
                                       "strdup=_strdup"]);
            cpp.cxxFlags: outer.concat(["/wd4028",
                                        "/wd4244",
                                        "/wd4267",
                                        "/wd4996",
                                        "/wd4291",
        ...
        Properties {
            condition: minGW
            cpp.defines: outer.concat(["__USE_MINGW_ANSI_STDIO=1"]);
            cpp.cxxFlags: outer.concat(["-Wno-missing-field-initializers",
        ...
        Properties {
            ...
            cpp.cxxFlags: outer.concat(["-Wno-missing-field-initializers",
                                        ...
                                        "-Wno-ignored-qualifiers",
                                        "-Wno-reorder"]);
            cpp.cFlags: outer.concat(["-Wno-unused-parameter"]);
        }


        cpp.includePaths: {
            if (qbs.toolchain.contains("msvc"))
                return [product.sourceDirectory + "/mesa",
                        product.sourceDirectory + "/../include",
                        product.sourceDirectory + "/../include/c99"];
              else
                  return [product.sourceDirectory + "/mesa",
                          product.sourceDirectory + "/../include"];
      }
